...
urlpatterns = [
    ...
    path('clientsprofile/<int:client_id>/',
         views.client_profile, name='clientsprofile'),
    path('clientsinformation/<int:client_id>/',
         views.client_information, name='clientsinformation'),
    ...
    path('reset_password/', PasswordResetView.as_view(
        template_name='app/reset_password.html'), name="reset_password"),
    ...
    # encodes user ID in base 64, then uses the token to check if the password is valid, part of PasswordResetConfirmView documentation
    path('reset/<uidb64>/<token>/', PasswordResetConfirmView.as_view(
        template_name='app/reset_password_confirm.html'), name="password_reset_confirm"),
